...
\end{equation}
The imaginary unit $i$ is not inserted by hand---it is \emph{generated} by the alternating-sign structure of the discrete geometry. The sign pattern $(-,+,-,+)$ is itself forced by the requirement that the operator annihilate polynomials of degree $\le 3$ while extracting the fourth derivative (the moment conditions of Section~\ref{sec:bd_derivation}).
