...
(Vol~II, Teorema~\ref*{thm:uniqueness}): en un grafo libre de $K_3$,
...
topol\'ogico fundamental (Vol~II, Definici\'on~\ref*{def:per-charge-flux}).
...
\subsection*{P6. El Candado $\alpha$--$\Omega$ (Abierto)}
...
activa.  Dado que $\alpha = \mathcal{Q}_{\mathrm{topo}}/(8\pi)$
(C6), se obtiene la \emph{identidad algebraica exacta}:
\[
  \boxed{\;\alpha\,(1 + \Omega_{\mathrm{energy}}) = \frac{1}{8\pi}\;\,.}
\]
Una \'unica medici\'on---$\mathcal{Q}_{\mathrm{topo}}$---determina
simult\'aneamente $\alpha$ y $\Omega_{\mathrm{energy}}$: no hay
par\'ametros libres.

\medskip\noindent
\textit{Resultado num\'erico}: con $\mathcal{Q}_{\mathrm{topo}} \approx 0.190$
se obtiene $\alpha^{-1} \approx 132$ y $\Omega_{\mathrm{energy}} \approx 4{.}25$.
El valor termodin\'amico ($\alpha \to 1/137$) predice
$\Omega_{\mathrm{energy}} \to 4{.}45$; el residuo respecto del valor
Planck~2018 ($5{.}36$) se atribuye al sector de confinamiento bari\'onico
$K_{3,3}$, a\'un no implementado.
...
La constante de estructura fina emerge como
$\alpha = \mathcal{Q}_{\mathrm{topo}} / (8\pi)$, donde el factor
...
La identidad exacta $\alpha\,(1 + \Omega) = 1/(8\pi)$ enlaza ambas
cantidades: no se puede variar la materia oscura sin alterar la
constante de estructura fina.

Con $\mathcal{Q}_{\mathrm{topo}} \approx 0.190$ del ensemble
$N = 10^7$: $\alpha^{-1} \approx 132$ y $\Omega_{\mathrm{energy}}
\approx 4.25$ (Planck~2018: $\approx 5.36$). El residuo del
${\sim}17\%$ cuantifica la contribuci\'on de masa din\'amica por
confinamiento bari\'onico ($K_{3,3}$).

\medskip\noindent
\textit{Estado}: \textbf{demostrado} (Teoremas de Coherencia de Fase
y Constante de Estructura Fina Emergente, Vol~II~\S\ref{sec:dark-matter}).
